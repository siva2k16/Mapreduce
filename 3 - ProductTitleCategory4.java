...
public class ProductTitleCategory4
{
   ...
   public static void main(String[] args) throws Exception
    {
        ...
        job.setJarByClass(ProductTitleCategory4.class);
        ...
        FileOutputFormat.setOutputPath(job, new Path("/home/cloudera/Public/output_productcategory"));
